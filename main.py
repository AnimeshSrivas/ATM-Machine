...
def owner(data):
  if data=="6390129813":
    ...
    print("NAME : ANIMESH SRIVASTAVA\nACCOUNT NO : 6390129813\nTYPE : SAVINGS ACCOUNT\nTOTAL BALANCE :",Tamount,"\nBRANCH : NOIDA\nGMAIL : ANIMESHLALA143@GMAIL.COM ")
    print("▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎\n▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎")
  elif data=="8882092012":
     print("▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎\n▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎")
     print("NAME : ANKIT KUMAR\nACCOUNT NO : 8882092012\nTYPE : SAVINGS ACCOUNT\nTOTAL BALANCE :",Tamount,"\nBRANCH : DELHI\nGMAIL : ANKITKUMAR04@GMAIL.COM")
     print("▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎\n▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎")
  elif data=="9415045383":
     print("▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎\n▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎")
     print("NAME : VINAYAK GAUR\nACCOUNT NO : 9415045383\nTYPE : SAVINGS ACCOUNT\nTOTAL BALANCE :",Tamount,"\nBRANCH : GREATERNOIDA\nGMAIL : VINAYAKGAUR2003GMAIL.COM")
     print("▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎\n▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎▪︎")
  else:
     print("***SORRY BRO!!!THIS IS NOT FOUND***")
Tamount=10000
wamount=0
d=0
w=0
